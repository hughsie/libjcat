...
X509 *
fwupd_jcat_libcrypto_pkcs7_load_crt_from_blob_pem(GBytes *blob, GError **error) G_GNUC_NON_NULL(1);
X509 *
fwupd_jcat_libcrypto_pkcs7_load_crt_from_blob_der(GBytes *blob, GError **error) G_GNUC_NON_NULL(1);
EVP_PKEY *
...
gchar *
fwupd_jcat_libcrypto_x509_get_issuer_name(X509 *crt, GError **error) G_GNUC_NON_NULL(1);
