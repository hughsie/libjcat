...
static void
jcat_parse_private_key_func(void)
{
...
static void
jcat_parse_public_key_func(void)
{
...
static void
jcat_parse_checkpoint_func(void)
{
...
main(int argc, char **argv)
{
	...
	g_test_add_func("/jcat/parse_private_key", jcat_parse_private_key_func);
	g_test_add_func("/jcat/parse_public_key", jcat_parse_public_key_func);
	g_test_add_func("/jcat/parse_checkpoint", jcat_parse_checkpoint_func);
	return g_test_run();
}
