...
struct _FwupdJcatSha512Engine {
	FuJcatEngine parent_instance;
};

G_DEFINE_TYPE(FwupdJcatSha512Engine, fu_jcat_sha512_engine, FU_TYPE_JCAT_ENGINE)
...
static void
fu_jcat_sha512_engine_class_init(FwupdJcatSha512EngineClass *klass)
{
...
static void
fu_jcat_sha512_engine_init(FwupdJcatSha512Engine *self)
{
}
...
fu_jcat_sha512_engine_new(FuJcatContext *context)
{
	...
	return FWUPD_JCAT_ENGINE(g_object_new(FU_TYPE_JCAT_SHA512_ENGINE,
					      "context",
					      context,
					      "kind",
